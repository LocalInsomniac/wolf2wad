...
DoomEdNums are from [`WOLFDOOM.wad`](https://files.cantsleep.cc/WolfenDOOM/WolfenDOOM%20Redux/WOLFDOOM.wad)
(check the DECOHACK lump).

Thanks to [cwolfmap](https://github.com/cxong/cwolfmap) for RLEW and Carmackize
